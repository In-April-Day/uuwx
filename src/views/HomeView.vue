...
<template>
  <div class="min-h-screen">
    <section class="container mx-auto px-4 py-8 md:py-12">
      <div class="max-w-6xl mx-auto flex items-center justify-center min-h-[calc(100vh-8rem)]">
        
        <!-- 左侧：简介背景板 -->
        <div class="hidden lg:flex flex-1 lg:max-w-md justify-center items-center">
          <div
        ...
        <!-- 右侧：四个核心交互元素，垂直分布，左右错位 -->
        <div class="flex-1 flex flex-col justify-evenly items-center gap-8 lg:gap-4 w-full max-w-md mx-auto">
          ...
          <!-- 元素2：SVG服务器（右侧，右对齐） -->
          <div class="w-full flex justify-end pr-4 lg:pr-8">
            <svg
              id="svg-global"
